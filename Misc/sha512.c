...
#else
#define SWAP(n)                                                                                \
  (((n) << 56) | (((n)&0xff00) << 40) | (((n)&0xff0000UL) << 24) | (((n)&0xff000000UL) << 8) | \
   (((n) >> 8) & 0xff000000UL) | (((n) >> 24) & 0xff0000UL) | (((n) >> 40) & 0xff00UL) |       \
   ((n) >> 56))
#endif
...
void *sha512_read_ctx(const struct sha512_ctx *ctx, void *resbuf) {
  ...
  for (i = 0; i < 8; i++) ((uint64_t *)resbuf)[i] = SWAP(ctx->state[i]);
...
void *sha384_read_ctx(const struct sha512_ctx *ctx, void *resbuf) {
  ...
  for (i = 0; i < 6; i++) ((uint64_t *)resbuf)[i] = SWAP(ctx->state[i]);
