...
static unsigned base64_decode_length(unsigned length) { return BASE64_DECODE_LENGTH(length); }

const struct nettle_armor nettle_base64 = _NETTLE_ARMOR(base64, BASE64);
