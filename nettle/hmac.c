...
void hmac_set_key(void *outer, void *inner, void *state, const struct nettle_hash *hash,
...
void hmac_digest(const void *outer, const void *inner, void *state, const struct nettle_hash *hash,
